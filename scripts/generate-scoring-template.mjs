...
const ROWS = [
  ...
  { criterio: 2, dimensao: "Interesse", maxDim: 30, secao: "Soluções de Interesse", campo: "solutions", opcao: "Betumes e Emulsão", perfil: "Empresa / Órgão Público", notas: "Multi-seleção; soma com teto 30" },
  ...
  { criterio: 3, dimensao: "Potencial", maxDim: 20, secao: "Betumes e Emulsão (condicional)", campo: "angobetumes_activity", opcao: "Construção Civil", perfil: "Empresa / Órgão Público", notas: "Dropdown — área de actividade" },
  { criterio: 3, dimensao: "Potencial", maxDim: 20, secao: "Betumes e Emulsão (condicional)", campo: "angobetumes_activity", opcao: "Obras Públicas", perfil: "Empresa / Órgão Público", notas: "Dropdown — área de actividade" },
  { criterio: 3, dimensao: "Potencial", maxDim: 20, secao: "Betumes e Emulsão (condicional)", campo: "angobetumes_activity", opcao: "Infra-estruturas Rodoviárias", perfil: "Empresa / Órgão Público", notas: "Dropdown — área de actividade" },
  { criterio: 3, dimensao: "Potencial", maxDim: 20, secao: "Betumes e Emulsão (condicional)", campo: "angobetumes_activity", opcao: "Indústria", perfil: "Empresa / Órgão Público", notas: "Dropdown — área de actividade" },
  { criterio: 3, dimensao: "Potencial", maxDim: 20, secao: "Betumes e Emulsão (condicional)", campo: "angobetumes_activity", opcao: "Distribuidor de Materiais", perfil: "Empresa / Órgão Público", notas: "Dropdown — área de actividade" },
  { criterio: 3, dimensao: "Potencial", maxDim: 20, secao: "Betumes e Emulsão (condicional)", campo: "angobetumes_activity", opcao: "Outro", perfil: "Empresa / Órgão Público", notas: "Dropdown — área de actividade" },
